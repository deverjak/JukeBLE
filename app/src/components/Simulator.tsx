...
/**
 * DEV-only reader simulator — feeds UIDs into the same pipeline as BLE
 * notifications, so the whole registration/play flow can be exercised
 * without the ESP32. Not rendered in production builds.
 */
    ...
    <View>
      ...
      <Card style={{ padding: 14 }}>
        <Text
          ...
          Vývojový režim — pošle UID do aplikace, jako by přišlo z BLE čtečky.
        </Text>
